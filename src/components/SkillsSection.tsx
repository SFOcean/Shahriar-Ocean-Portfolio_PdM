  ...
  const skillCategories = [
    {
      title: 'Product Tools',
      skills: [
        { name: 'FigJam', level: 95, color: 'from-blue-400 to-blue-600' },
        { name: 'Figma', level: 90, color: 'from-blue-500 to-blue-700' },
        { name: 'Power BI', level: 88, color: 'from-cyan-400 to-cyan-600' },
    ...
    },
    {
      title: 'AI Tools',
      skills: [
        { name: 'Google Geminie Pro', level: 90, color: 'from-green-500 to-green-700' },
